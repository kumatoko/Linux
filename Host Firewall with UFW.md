## Setting up and using UFW (Uncomplicated Firewall)
...
By default, ufw should deny all incoming connections and allow all outgoing connections. To check this you must first enable ufw with
...
```
I then moved that backup file over to my /var/log using
```

sudo mv ufw-backup.txt > /var/log
